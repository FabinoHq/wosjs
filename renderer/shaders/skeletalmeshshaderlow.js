...
const skeletalMeshVertexShaderLowSrc = [
    ...
    "    skinMatrix += boneMatrix(bonesIndices[1])*bonesWeights[1];",
    "    skinMatrix += boneMatrix(bonesIndices[2])*bonesWeights[2];",
    "    skinMatrix += boneMatrix(bonesIndices[3])*bonesWeights[3];",
    "",
    "    // Output",
