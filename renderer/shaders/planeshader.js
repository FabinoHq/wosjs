...
//      renderer/planeshader.js : Plane shader                                //
////////////////////////////////////////////////////////////////////////////////
...
const planeVertexShaderSrc = [
    ...
    "",
    "    // Shadows cast",
    "    shadowsTexCoord = shadowsMatrix*modelMatrix*vec4(vertexPos, 1.0);",
    "",
    "    // Dynamic lights",
    ...
    "",
    "    // TBN matrix",
    "    vec3 t = normalize(mat3(modelMatrix)*vertexTan);",
    "    vec3 n = normalize(mat3(modelMatrix)*vertexNorm);",
